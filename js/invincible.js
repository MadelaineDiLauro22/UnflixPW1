window.onload = function() {
    let temp1 = ["Seleccionar Capitulo", "Ya era hora", "Aqui vamos", "A quien llamas feo?", "Neil Armstrong, muerete de envidia", "Eso me dolio", "Te ves muy mal", "Tenemos que hablar", "Mi verdadero lugar de origen"];
